...
| Northern Ireland 2021 Census super data zones | Northern Ireland statistics and research Agency | 2021 | [link](https://www.nisra.gov.uk/publications/super-data-zone-boundaries-gis-format) ||
| uk lad>nuts3 lookup table | UK office for national statistics | 2018 | [link](https://geoportal.statistics.gov.uk/datasets/0de287b886954f54b4c2fffcfd514079_0/explore) | This is the last year for which I could find this type of lookup table due to brexit. There is a chance that data for UK is skewed or incomplete due to this. |
...
| High resolution layer croplands | Copernicus LMS | 2023 | [link](https://land.copernicus.eu/en/products/high-resolution-layer-croplands) | NOTE: Downloading this without the api is prohibitively tedious, see the script for streamlined API calls: [download_crop_data.ipynb](scripts/download_crop_data.ipynb)|
