...
map.once("load", async () => {
  ...
  document.getElementById('source').innerHTML = `${translate('source')}: <a target="_blank" style="color:#333333; text-decoration-color:#FF5064;" href="https://drought.emergency.copernicus.eu/data/factsheets/factsheet_combinedDroughtIndicator_v4.pdf">Copernicus - Combined Drought Indicator<a>`;
